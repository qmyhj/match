...
class Config(object):
    def __init__(self):
        ...
        self.dropout = 0.5
        self.num_layers = 2
        self.save_path = './model_dict/gru_age.ckpt'
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        self.gru = nn.GRU(808, config.hidden_size, num_layers=config.num_layers, batch_first=True, dropout=config.dropout, bidirectional=True)
    ...
    def load_pretrain_embedding(self, config):
        ...
        model_2 = gensim.models.Word2Vec.load('./word2vec/ad_id_512.model')
