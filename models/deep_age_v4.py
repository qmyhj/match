...
class Config(object):
    def __init__(self):
        ...
        self.pad_size = 128
        self.num_epochs = 5
        self.save_path = './model_dict/deep_age_attr_v4.ckpt'
...
class Model(nn.Module):
    def __init__(self, config):
        ...
        # self.creative_id_embedding = nn.Embedding.from_pretrained(creative_id, freeze=False)
        ...
        self.weight_W = nn.Parameter(torch.Tensor(808, 512))
        self.weight_proj = nn.Parameter(torch.Tensor(512, 1))
